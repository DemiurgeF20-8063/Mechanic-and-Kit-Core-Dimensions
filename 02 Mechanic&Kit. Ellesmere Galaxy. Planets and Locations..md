# Mechanic&Kit. Ellesmere Galaxy. Planets and Locations.
...
The name is derived from the location of the Salk Institute (La Jolla, California), one of the world's most prestigious biological research centers. It was here that scientists successfully created viable chimeric embryos for the first time in history.
...
###### Acid Lakes
It is here that Witya and Boris will need to do some weeding of the aggressive flora and fauna in order to secure the construction site.

###### Abandoned Complex
A complex of unknown purpose that was previously located on this planet. The purpose of the complex is unknown. Inside, players can find a Nirgenium Shard, but entering is impossible without solving a puzzle for Kat.

###### Sellof Sterces' Shack
A small building where this smuggler is hiding.
...
The name is derived from the Registan Desert (Registan, Afghanistan)—a vast desert plateau covered with dark red and reddish-orange sand dunes. Constant strong winds cause these dunes to move at high speeds, burying any structures in their path. Remhen brought Witya to this planet and dropped him right in the middle of the sands.
The planet contains two locations:

###### Sonroa Desert
The name is derived from the world's most famous place with an extreme concentration of giant cacti, the Sonora Desert (Sonora), located on the US-Mexico border. It is in this desert that Witya is forced to run around collecting cacti for the Meditating Krunch so that he will reveal the path to the city.

###### Seddjona Tunnel
The name is derived from the cave arches of Sedona (Red Rocks of Arizona)—an area famous for its crimson-red rocks blazing in the sun. There are through-caves there (such as Keyhole Cave or Subway Cave) that cut entirely through the rock ledges, creating ideal geometries resembling "doors" and lancet windows. It is through this cave that Witya fights his way to the city that Kranch tipped him off about, only to find a dead-end clearing where he encounters the Mysterious Thief.

---

# Avamis Nebula (CaR)

The name is derived from Awashima (Japan)—high-tech Japanese island factories dedicated to the total thermal disposal and recycling of complex industrial waste.
...
# Merc-4-more Prison Ship (CaR)

A prison ship belonging to the Merc-4-more mercenaries. In a ship like this, they hold prisoners who, at the client's request, must remain alive, hold value for blackmail or ransom, or have simply been slated to become slaves.
This ship contains three locations:

###### Ventilation
Katya and Taisi use it to fight their way through the vents and maintenance corridors—which were designed for small service robots—to reach the primary prison cell control and monitoring center, ultimately cutting power to the prison block at the end.

###### Armory
Here, Witya finds his arsenal, as well as the Goatmorpher. The corridors leading to the armory are also considered part of this location.

###### Bridge
Here, Witya finds out where Diana was sent. The corridors leading to the bridge are also considered part of this location.

---

# Mastorfen (CaR)

The name is derived from a heavily distorted version of the word Mustafar, the name of a very well-known planet from Star Wars. It is on this planet that the main Merc-4-more base is located, where Diana was imprisoned.
The planet features two locations:

###### Widerra Fortress
The name is derived from Darth Vader's Castle, which was built on Mustafar. Due to the presence of a similar fortress on the planet, it was given this specific name. Witya lands very close to the fortress because he is piloting a stolen Merc-4-more fighter. However, the alarm triggers quickly, causing many doors to become locked, and Witya is forced to buy a Lockpasser at the mercenary terminal.

###### Backyard
The place where a giant mech, piloted by Antiag Ingpil, clashes in battle with Witya and Katya in her combat form. Diana Clum is locked right inside the chest of this mech.
...
The name of the planet is derived from the word "Hipnosis", which translates from Latin as "Hypnosis". And, once again... An entire planet is named after a character who is connected to hypnosis. Three locations are situated on the planet:

###### Hoverbike Track
On this track, Witya and Diana earn the opportunity to meet with Kevin Mayatnikus. In general, of course, it turns out quite strange that a person obsessed with hypnosis is located in such an odd place, but I needed to introduce Tuzik and Warmer because they will be needed later on. I also needed one more mission-location to bring the total number up to 17—matching the number of missions in the previous game.

###### Jungle
Here, players can simply run around, search for Haufitum and bolt crates. They can explore the area while fighting off local predators.

###### Merc-4-more Outpost
In the middle of the jungle, Witya and Diana can stumble upon a Merc-4-more Outpost. If they storm it, they will find a crate inside labeled "Property of Sellof Sterces". If smashed, a device of unknown purpose will be found inside. If it is handed over to Sellof, he will give a discount on his assortment.

---

# Collin (CaR)

The name of the planet is derived from the word "collina", which translates from Latin as "Hill". The planet itself is a hilly plain, ideal for the existence of large predatory creatures, such as the Grinter. Despite their dry appearance, they contain a lot of fat, which is used in cooking or, illegally, as a soldering flux (recalling the environment from Witya's first game), and they communicate with each other using pheromones. The planet contains one location:

###### Crash Clearing
It is exactly on this clearing that Witya and Diana land in search of a Grinter. Natural selection simply did not allow these creatures to become highly prolific due to the massive size of this dinosaur-like being. In addition to the Grinter itself, the heroes find 12 logs recorded by Dmitry Hepunkt in this clearing.
